...
# has to be changed
start_entry <- list(1, 20000, 1, 1, 15000,
                    35000, 1, 25000, 25000, 50000)

end_entry   <- list(40000, 62000, 75000, 7500, 62500,
                    65000, 75000, 57000, 72500, 82000)

start_exit  <- list(170000, 197500, 540000, 96000, 360000,
                    172500,337500, 164000, 243000, 595000)

end_exit    <- list(210000, 225000, 625000, 115000, 425000,
                    195000,395000, 185000, 280500, 680000)
